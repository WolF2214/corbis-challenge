...
from base.views import CustomLoginView, RegisterPage, ItemList, ItemCreate, ItemUpdate, ItemDeleted
...
urlpatterns = [
    ...
    path('item-delete/<int:pk>/', ItemDeleted.as_view(), name='item-delete'),
]
